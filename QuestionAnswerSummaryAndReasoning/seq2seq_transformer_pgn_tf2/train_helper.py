...
import time
from QuestionAnswerSummaryAndReasoning.seq2seq_transformer_pgn_tf2.layers.transformer import create_masks
from QuestionAnswerSummaryAndReasoning.seq2seq_transformer_pgn_tf2.schedules.lr_schedules import CustomSchedule
...
def loss_function(real, pred):
    ...
    mask = tf.math.logical_not(x=tf.math.equal(real, 1))
