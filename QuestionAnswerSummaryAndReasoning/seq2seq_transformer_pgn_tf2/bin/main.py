...
import argparse
from QuestionAnswerSummaryAndReasoning.seq2seq_transformer_pgn_tf2.train_eval_test import train, predict_result
...
def main():
    ...
    parser.add_argument('--dff', default=2048, type=int, help="hidden dimension of feedforward layer")
