...
def main():
    ...
    parser.add_argument("--train_seg_x_dir", default='{}/data/train_set.seg_x.txt'.format(BASE_DIR),
                        help="train_seg_x_dir")
    parser.add_argument("--train_seg_y_dir", default='{}/data/train_set.seg_y.txt'.format(BASE_DIR),
                        help="train_seg_y_dir")
    parser.add_argument("--test_seg_x_dir", default='{}/data/test_set.seg_x.txt'.format(BASE_DIR),
                        help="test_seg_x_dir")
